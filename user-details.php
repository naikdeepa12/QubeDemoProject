    ...
    <div class="wrapper">
        ...
        <form id="frm-mobile-verification" method="post" >
            <div class="form-group">
                ...
                <input type="text" id="mobile" name="mobile" class="form-control" placeholder="Enter the 10 digit mobile" value="<?php echo $item->contact; ?>">
            </div>  
			<div class="form-group">
                <label>Name</label>
                <input type="text" id="name" name="name" class="form-control" placeholder="Enter your name" value="<?php echo $item->name; ?>">
            </div> 
			<div class="form-group">
                <label>Email ID</label>
                <input type="text" id="email" name="email" class="form-control" placeholder="Enter your email id" value="<?php echo $item->email; ?>">
            </div> 
